...
df = pd.read_excel(r'C:\Users\admin\Desktop\运营分析报表.xlsx')  #压缩文件
df2 = pd.read_excel(r'D:\资料\亚信\作业\冬奥\日\123.xlsx')   #123，只需要行名
...
writer = pd.ExcelWriter(r'C:\Users\admin\Desktop\123.xlsx', engine='xlsxwriter',
