...
df = pd.read_excel(r'D:\亚信\7入数据库\源表\运营指标监控报表.xlsx')
df2 = pd.read_excel(r'D:\亚信\7入数据库\参照表\指标监控报表参照.xlsx')
...
writer = pd.ExcelWriter(r'D:\亚信\7入数据库\结果表\指标监控报表.xlsx', engine='xlsxwriter',
