...
df = pd.read_excel(r'D:\亚信\7入数据库\源表\运营分析报表.xlsx')  #压缩文件
df2 = pd.read_excel(r'D:\亚信\7入数据库\参照表\运营分析参照.xlsx')   #123，只需要行名
...
writer = pd.ExcelWriter(r'D:\亚信\7入数据库\结果表\运营分析报表.xlsx', engine='xlsxwriter',
                        datetime_format='yyyy/m/d')        #输出路径
